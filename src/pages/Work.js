...
export const workContent = [
  {
    img: <img src={softiesSS} alt="Softies Web" />,
    title: "Softies",
    content:
  ...
  {
    img: <img src={blogSiteSS} alt="Blog Web" />,
  ...
  {
    img: <img src={calcAppSS} alt="Calc App" />,
    ...
    return (
      <div className="workBox">
        ...
        <div className="myContent">
          ...
          <p>{content}</p>
          <a className="siteLink" href={link} target="_blank" rel="noreferrer">
            Visit WebSite
          </a>
        </div>
      </div>
